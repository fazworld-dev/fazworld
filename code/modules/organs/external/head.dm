...
/obj/item/organ/external/head/robotize(var/company = /decl/prosthetics_manufacturer, var/skip_prosthetics = 0, var/keep_organs = 1, var/apply_material = /decl/material/solid/metal/steel, var/check_bodytype, var/check_species/*FAZ-WORLD EDIT START*/, var/robotize_children = TRUE /*FAZ-WORLD EDIT END*/)
	. = ..()
	has_lips = null
	if(model)
